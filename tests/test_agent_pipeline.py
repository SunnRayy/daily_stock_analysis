...
class TestAgentConstructionChain(unittest.TestCase):
    ...
    def test_convert_messages_uses_instance_config(self):
        """_convert_messages should use adapter config, not an undefined local variable."""
        ...
        self.assertIn("reasoning_content", converted[0])
